...
namespace TestProject1
{
    public class Tests
    {
        ...
        public string filePath = @"C:\Users\SOURABH\Desktop\RFP\IndianStatesCensus\TestProject1\Files\StateCensusData - StateCensusData.csv";
        //TC1.1
        [Test]
        ...
        {
            string filePath1 = @"C:\Users\SOURABH\Desktop\RFP\IndianStatesCensus\TestProject1\Files\StateCensusData - StateCensusData.csv";
            InformationAnalyze informationAnalyze = new InformationAnalyze();
            try
            {
        ...
        public void GivenStateCensusDataFileInCorrectDelimiter_WhenAnalyze_ShouldReturnException()
        {
            ...
            try
            {
                int records = informationAnalyze.ReadData(@"C:\Users\SOURABH\Desktop\RFP\IndianStatesCensus\TestProject1\Files\Delimiter.csv");
            }
            catch (StateCensusException ex)
            {
        ...
        public void GivenStateCensusDataFileInCorrectType_WhenAnalyze_ShouldReturnException()
        {
            ...
            try
            {
                int records = informationAnalyze.ReadData(@"C:\Users\SOURABH\Desktop\RFP\IndianStatesCensus\TestProject1\Files\StateCensusData.txt");
            }
            catch (StateCensusException ex)
            {
